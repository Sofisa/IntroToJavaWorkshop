...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("Scare maze.jpg"));
		//2. set the mouse pointer to the start of your maze using:
		new Robot().mouseMove(40, 130);
...
int endcolor = -2218310;
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("239900__thesubber13__scream-1.ogg"));
...
showScaryImage("scary picture.jpg");
	}
